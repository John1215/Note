...
public class RecyclerViewSwipe extends RecyclerView {
    ...
    public RecyclerViewSwipe(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        //滑动的最大距离
        maxLength = ((int) (200 * context.getResources().getDisplayMetrics().density + 0.5f));
        //初始化Scroller
                                ...
                                if (Math.abs(dy) < 5 && Math.abs(dx) < 5) {
                                    ...
                                    if (Math.abs(dy) < mTouchSlop * 2 && Math.abs(dx) > mTouchSlop) {
                                        ...
                                        if (scrollX > maxLength *0.67) {
                                            ...
                                            if (isFirst) {
                                                ObjectAnimator animatorX = ObjectAnimator.ofFloat(imageView, "scaleX", 1f, 1.8f, 1f);
                                                ObjectAnimator animatorY = ObjectAnimator.ofFloat(imageView, "scaleY", 1f, 1.8f, 1f);
